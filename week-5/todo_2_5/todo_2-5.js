...
.then(response => {
    ...
    h3.textContent = "Item description:" + response.data[i].description;
    li.appendChild(h3);
    ...
    checkbox.addEventListener("click", (event) => {
        ...
        axios.put("https://api.vschool.io/caseysherman/todo/" + event.currentTarget.id, {completed:updates})
    ...
    const button = document.createElement("button")
        ...
        axios.delete("https://api.vschool.io/caseysherman/todo/" + event.currentTarget.id)
...
form.addEventListener("submit", function(event){
    ...
    axios.post("https://api.vschool.io/caseysherman/todo/", newTodo)
        .then(response => {response.data 
        form.reset()})
        .catch(error => console.log(error))
